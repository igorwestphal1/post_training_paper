...
mapes = pd.read_csv("2_output\mapes_dnn.csv")
...
stats.to_csv('2_output/error_stats_dnn.csv')
...
# output
stats_by_hour.to_csv('2_output/stats_by_hour_dnn.csv')
...
plt.plot(a['1.0'], label='DNN', linestyle='solid', linewidth = 1, color = 'blue')
# plt.plot(a['1.2'], alpha = 0.5)
# plt.plot(a['1.5'], alpha = 0.5)
plt.plot(a['avg'], label='DNN+PTS', linestyle='solid', linewidth = 1, color = 'red')
plt.ylim(3.5,8.5)
...
plt.grid(True)
plt.tight_layout()
plt.savefig('2_output/mape_per_hour_dnn.pdf')
...
# output
stats_by_decile.to_csv('2_output/stats_by_decile_dnn.csv')
...
plt.grid(True)
plt.tight_layout()
plt.savefig('2_output/mape_per_decile_dnn.pdf')
...
plt.colorbar()
plt.show()
fig1.savefig('2_output/comparison_dnn.pdf')
